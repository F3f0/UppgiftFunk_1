...
public class TomtelandTest {
    ...
    List<String> uButter = Arrays.asList("Bladlusen","Myran","Gråsuggan","Rådjuret", "Nyckelpigan", "Haren", "Räven");
    List<String> uTrötter = Arrays.asList("Dammråttan", "Skumtomten");
    List<String> uSkumtomten = Arrays.asList("Dammråttan");
    List<String> uRäven = Arrays.asList("Bladlusen", "Myran", "Gråsuggan");
