...
public class RewriteMeTest {
    ...
    @Test
    final void getAnswerCandidateFrequencyTest(){
        assertEquals(x.getAnswerCandidateFrequency("Couscous"), 4);
        assertEquals(x.getAnswerCandidateFrequency("Guld"), 1);
        assertEquals(x.getAnswerCandidateFrequency("fsdfdss"), 0);
    }
